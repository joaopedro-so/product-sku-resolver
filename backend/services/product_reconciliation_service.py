...
class ProductReconciliationService:
    ...
    def build_candidate_product(
        ...
        return ProductRecord(
            ...
            site_candidate_url=incoming_site_product.last_known_url,
            site_candidate_code=incoming_site_product.variant_code,
            site_candidate_variant_id=incoming_site_product.site_variant_id,
            match_confidence=confidence,
            match_signals=match_signals or [],
            last_matched_at=_build_match_timestamp(),
